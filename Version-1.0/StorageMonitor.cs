...
{
  public class StorageMonitor : BaseComponent, ISamplingTransmitter, ITransmitter, IPersistentEntity, IDuplicable<StorageMonitor>, IDuplicable, IInitializableEntity, IStartableComponent
  {
    ...
    public void Sample()
    {
      ...
      {
        // Try to auto-adopt the specific item the storage is holding
      ...
      {
        // If pointing at dirt or an empty space, zero everything out
        SampledResourceCount = 0;
        SampledFillRate = 0f;
      }
